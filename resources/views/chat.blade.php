...
<body>
  ...
  <li class="list-group-item active">Chat Rooms<span class="badge badge-success">@{{numberOfUsers}}</span></li>
...
<a href="" class="btn-sm btn-danger" @click="deleteChat"> Delete Chat</a>
</div>
        </div>
    </div>
